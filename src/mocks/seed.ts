...
export const MOCK_BRANCHES: Branch[] = MOCK_BRANCH_LOCATIONS.map((loc, i) => ({
...
export const MOCK_USERS: User[] = [
  ...
  },
  {
    ...
    branchCode: MOCK_BRANCHES[0].code,
  ...
  },
  {
    ...
    roleName: "Manager",
    branchId: MOCK_BRANCHES[1].id,
    branchName: MOCK_BRANCHES[1].name,
    branchCode: MOCK_BRANCHES[1].code,
  ...
  },
  {
    ...
    roleName: "Employee",
    branchId: MOCK_BRANCHES[2].id,
    branchName: MOCK_BRANCHES[2].name,
    branchCode: MOCK_BRANCHES[2].code,
    department: "Engineering",
    status: "active",
